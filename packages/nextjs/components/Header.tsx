...
export const Header = () => {
  return (
    <div className="py-4 sticky top-0 navbar bg-base-100 min-h-0 shrink-0 justify-between items-center z-20 shadow-md shadow-secondary px-2 sm:px-4">
      <div className="navbar-start w-auto">
        <Link href="/" passHref className="flex items-center gap-2 shrink-0">
          <div className="flex relative w-10 h-10 sm:w-10 sm:h-10 flex-shrink-0">
